...
class IsChangeThread(Thread):
    def run(self):
        ...
        while True:
            ...
            #org_node_list = node_list[0:len(node_list)]
            ...
            if flag == 1:
                print("check!! : " + str(len(org_node_list)))
                for i in range(0, num_of_nodes) :
                    print("org nodes : "+ str(org_node_list[i]))
                    ...
                    if i == (num_of_nodes -1) :
                        del_idx = i+1
                if IS_MANAGER == 1:
                    print("delete " + org_node_list[del_idx])
                    del ALERT_TABLE[org_node_list[del_idx]]
                    print("after deleted "+str(len(ALERT_TABLE)) + "node lefted")
